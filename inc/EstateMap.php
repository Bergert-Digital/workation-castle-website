...
function workation_estate_map_pois() {
	return array(
		array(
			...
			'marker' => '1',
			'name'   => 'Casa Galbiga',
			'sub'    => __( 'guest house', 'pediment-child' ),
			'type'   => 'place',
			'x'      => 360,
			'y'      => 423,
		),
		array(
			'id'     => 'coworking',
			'marker' => '2',
			'name'   => __( 'Workspace', 'pediment-child' ),
			'sub'    => '',
			'type'   => 'place',
			'x'      => 467,
			'y'      => 389,
		...
		array(
			'id'     => 'bar',
			'marker' => '3',
			'name'   => __( 'Bar', 'pediment-child' ),
			'sub'    => __( 'coffee machine and water dispenser', 'pediment-child' ),
			'type'   => 'place',
			'x'      => 485,
			'y'      => 336,
		),
		...
		array(
			'id'     => 'waste',
			'marker' => '5',
			'name'   => __( 'Waste Collection Point', 'pediment-child' ),
			'sub'    => '',
			'type'   => 'service',
			'x'      => 467,
			'y'      => 312,
		...
		array(
			'id'     => 'parking',
			'marker' => 'P',
			'name'   => __( 'Parking', 'pediment-child' ),
			'sub'    => __( 'on Via Castello (on the right side)', 'pediment-child' ),
			'type'   => 'service',
			'x'      => 44,
			'y'      => 318,
		),
