...
<p class="wc-kicker">Off-sites that actually work</p>
<!-- /wp:paragraph -->
<!-- wp:heading -->
<h2 class="wp-block-heading">A whole castle for your team, not a hotel conference floor</h2>
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p>Renting Workation Castle gives your team the run of the place: two private houses, a dedicated co-working space and the gardens, all to yourselves. There's no lobby to cross, no other guests, and no 5pm hard stop — just room to think, decide and switch off together. It's built for company off-sites, leadership weeks, hackathons, planning sprints and coaching retreats of up to nine people.</p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p>Because everyone sleeps, works and eats on the same grounds, the day flows the way you want it to. Run a focused morning in the meeting room, break for a swim in the lake, and carry the conversation through to a long dinner on the terrace. The setting does a lot of the work that team-building exercises usually have to fake.</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</div>
...
<div class="wp-block-group sec-head">
<!-- wp:paragraph {"className":"wc-kicker"} -->
<p class="wc-kicker">How a retreat here runs</p>
<!-- /wp:paragraph -->
<!-- wp:heading -->
<h2 class="wp-block-heading">Easy to plan, easy to be present</h2>
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p>Most teams arrive on a Sunday or Monday and stay two to four nights. You set the agenda; we make sure the rooms, the Wi-Fi and the logistics are ready so nobody spends the off-site troubleshooting a projector. Tell us your group size and dates and we'll help with airport transfers, catering and a private chef, and ideas for half-day activities.</p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p>The location makes the breaks effortless. A swimmable lake sits a few minutes' walk away, forest trails and waterfalls start at the gate, and Lake Como and Lugano are both a short drive for an afternoon out. It's far enough to feel like a real change of scene, and close enough — about an hour from Milan Malpensa — that getting the team here is simple.</p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</div>
...
<!-- wp:pediment-child/workation-closing {"align":"full","headline":"Ready to plan your team retreat?","primaryText":"Check availability","primaryUrl":"https://workationcastle.holiduhost.com/","secondaryText":"Ask for a custom offer","secondaryUrl":"/contact/"} /-->
